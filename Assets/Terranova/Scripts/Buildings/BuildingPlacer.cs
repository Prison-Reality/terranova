    ...
    public class BuildingPlacer : MonoBehaviour
    {
        ...
        private GameObject CreateBuildingVisual(BuildingDefinition def, Vector3 position)
        {
            ...
            if (type.Contains("woodcutter") || type.Contains("holzf"))
                return CreateHutVisual(def, position, new Color(0.50f, 0.32f, 0.15f), // Wood brown
                    new Color(0.40f, 0.25f, 0.10f));
            if (type.Contains("hunter") || type.Contains("j\u00e4ger"))
                return CreateHutVisual(def, position, new Color(0.25f, 0.45f, 0.20f), // Forest green
        ...
        private GameObject CreateCampfireVisual(BuildingDefinition def, Vector3 position)
        {
            ...
            // Stone ring: 6 small cubes arranged in a circle
            for (int i = 0; i < 6; i++)
            {
            ...
            // Inner glow: smaller, brighter cone
            ...
            // Add a box collider on root for selection raycasting
        ...
        /// <summary>Work hut: rectangular base + triangular roof. Color accent per type.</summary>
            ...
            Color wallColor, Color roofColor)
        {
            ...
            // Roof: flattened cube rotated 45° (simple pitched roof)
            ...
            // Door indicator: small dark rectangle on front
        ...
        /// <summary>Simple hut (residential): slightly larger, warm tones.</summary>
        private GameObject CreateSimpleHutVisual(BuildingDefinition def, Vector3 position)
        {
            return CreateHutVisual(def, position,
                new Color(0.60f, 0.45f, 0.25f),  // Warm sandy walls
                new Color(0.45f, 0.30f, 0.15f));  // Dark wood roof
        }
        ...
        private static void EnsureCampfireMesh()
        {
            ...
            // Small cone for flames (6 segments for low-poly look)
            int segments = 6;
            float radius = 0.5f;
            float height = 1f;
