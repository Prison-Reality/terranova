...
namespace Terranova.Population
{
    ...
    public class Settler : MonoBehaviour
    {
        ...
        private const float BASE_WALK_SPEED = 1.0f;
        private const float TASK_WALK_SPEED = 1.0f;
        ...
        private const float SPEED_NORMAL = 1.0f;        // Normal walking
        private const float SPEED_SLUGGISH = 0.7f;      // Hungry
        private const float SPEED_STUMBLING = 0.45f;    // Exhausted
        private const float SPEED_CRAWLING = 0.15f;     // Starving
