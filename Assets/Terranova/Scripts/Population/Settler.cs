...
namespace Terranova.Population
{
    ...
    public class Settler : MonoBehaviour
    {
        ...
        private const float BASE_WALK_SPEED = 1.75f;
        private const float TASK_WALK_SPEED = 1.75f;
        ...
        private const float SPEED_NORMAL = 1.75f;       // Normal walking
        private const float SPEED_SLUGGISH = 1.25f;     // Hungry
        private const float SPEED_STUMBLING = 0.75f;    // Exhausted
        private const float SPEED_CRAWLING = 0.25f;     // Starving
